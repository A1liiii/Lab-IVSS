    ...
    <div class="admin-card p-4 shadow-sm" style="border-radius: 10px;">
        ...
        <form action="" method="POST">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select name="status" class="form-control">
                        <option value="on going" <?= $proyek['status']=='on going'?'selected':'' ?>>On Going</option>
            ...
            <div class="mb-3">
                ...
                <textarea name="deskripsi" class="form-control" rows="4"><?= htmlspecialchars($proyek['deskripsi']) ?></textarea>
            </div>
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        href="/lab-ivss/index.php?page=operator-proyek-anggota-delete&id=<?= $a['id'] ?>&proyek_id=<?= $proyek['id'] ?>"
            ...
            <h5 class="mb-3">Tambah Anggota Baru</h5>
