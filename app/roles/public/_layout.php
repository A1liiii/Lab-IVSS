...
<header id="header" class="header d-flex align-items-center fixed-top">
    <div class="container-fluid container-xl position-relative d-flex align-items-center">
      ...
      <nav id="navmenu" class="navmenu">
        <ul>
          <li><a href="home.php" class="active">Beranda<br></a></li>
            <li class="dropdown"><a href="about.php"><span>Tentang Kami</span></a>
          </li>
          <li class="dropdown"><a href="#"><span>Riset</span> <i class="bi bi-chevron-down toggle-dropdown"></i></a>
            <ul>
              <li><a href="proyek.php">Projek</a></li>
              <li><a href="publikasi.php">Publikasi</a></li>
            </ul>
          </li>
          <li class="dropdown"><a href="fasilitas.php"><span>Fasilitas</span></a>
          </li>
          <li class="dropdown"><a href="berita.php"><span>Berita</span> <i class="bi bi-chevron-down toggle-dropdown"></i></a>
            <ul>
              <li><a href="#">Pengumuman</a></li>
              <li><a href="#">Penghargaan</a></li>
            </ul>
          </li>
          <li class="dropdown"><a href="dokumentasi.php"><span>Galeri</span></a></li>
