...
<head>
  ...
  <title>Inteligence Vission And Smart System</title>
      ...
      <div class="container">
        <div class="row gy-4">
          <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center">
            <h1 data-aos="fade-up">Intelligence Vision and Smart System</h1>
            <p data-aos="fade-up" data-aos-delay="100">Menjelajahi Penelitian dalam Bidang intelligent vision, dan smart system.</p>
          ...
          <div class="col-lg-6 order-1 order-lg-2 hero-img" data-aos="zoom-out">
            <img src="public/assets/img/build.png" class="img-fluid animated" alt="">
          </div>
        </div>
      </div>
